<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="compan1.aspx.cs" Inherits="TayanaYachtRe.Tayanahtml.compan1" %>
...
<body>
    <form id="form1" runat="server" method="post">
      <div class="contain">
        ...
        <!--------------------------------左邊選單結束---------------------------------------------------->
        <!--------------------------------右邊選單開始---------------------------------------------------->
        <div id="crumb"><a href="index.aspx">Home</a> >> <a href="#">Company </a> >> <a href="#"><span class="on1">Certificat</span></a></div>
        <div class="right">
            <div class="right1">
