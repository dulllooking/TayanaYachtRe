<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new_view.aspx.cs" Inherits="TayanaYachtRe.Tayanahtml.new_view" %>
...
<body>
    <form id="form1" runat="server" method="post">
      <div class="contain">
        ...
        <!--------------------------------左邊選單結束---------------------------------------------------->
        <!--------------------------------右邊選單開始---------------------------------------------------->
        <div id="crumb"><a href="index.aspx">Home</a> >> <a href="new_list.aspx">News </a> >> <a href="javascript:window.history.back();"><span class="on1">News & Events</span></a></div>
        <div class="right">
            <div class="right1">
